...
async def auth_request(jsonrpc_request:dict, account:str='test', keys:tuple=('test'), url:str='https://api.dpays.io') -> dict:
...
async def get_user_data(username:str, account:str=None, keys:tuple=None, url:str='https://api.dpays.io') -> dict:
    rpc_request = {
        'id':     1, 'jsonrpc': '2.0',
